  ...
  //  { MP_ROM_QSTR(MP_QSTR_AF12_TIM1),       MP_ROM_INT(GPIO_AF12_TIM1) },
   // { MP_ROM_QSTR(MP_QSTR_AF13_TIM8),       MP_ROM_INT(GPIO_AF13_TIM8) },
    { MP_ROM_QSTR(MP_QSTR_AF14_TIM15),      MP_ROM_INT(GPIO_AF14_TIM15) },
    { MP_ROM_QSTR(MP_QSTR_AF14_TIM16),      MP_ROM_INT(GPIO_AF14_TIM16) },
    { MP_ROM_QSTR(MP_QSTR_AF14_TIM17),      MP_ROM_INT(GPIO_AF14_TIM17) },
  //  { MP_ROM_QSTR(MP_QSTR_AF14_TIM2),       MP_ROM_INT(GPIO_AF14_TIM2) },
    { MP_ROM_QSTR(MP_QSTR_AF1_TIM1),        MP_ROM_INT(GPIO_AF1_TIM1) },
    { MP_ROM_QSTR(MP_QSTR_AF1_TIM2),        MP_ROM_INT(GPIO_AF1_TIM2) },
    { MP_ROM_QSTR(MP_QSTR_AF1_TIM5),        MP_ROM_INT(GPIO_AF1_TIM5) },
    ...
    { MP_ROM_QSTR(MP_QSTR_AF3_I2C4),        MP_ROM_INT(GPIO_AF3_I2C4) },
#endif
#if defined(MICROPY_HW_SPI2_SCK)
    { MP_ROM_QSTR(MP_QSTR_AF3_SPI2),        MP_ROM_INT(GPIO_AF3_SPI2) },
#endif
   // { MP_ROM_QSTR(MP_QSTR_AF3_TIM1),        MP_ROM_INT(GPIO_AF3_TIM1) },
    { MP_ROM_QSTR(MP_QSTR_AF3_TIM8),        MP_ROM_INT(GPIO_AF3_TIM8) },
#if defined(MICROPY_HW_UART2_TX)
    { MP_ROM_QSTR(MP_QSTR_AF3_USART2),      MP_ROM_INT(GPIO_AF3_USART2) },
#endif
...
#endif
#if defined(MICROPY_HW_I2C4_SCL)
    { MP_ROM_QSTR(MP_QSTR_AF5_I2C4),        MP_ROM_INT(GPIO_AF5_I2C4) },
#endif
...
#endif
#if defined(MICROPY_HW_I2C3_SCL)
    { MP_ROM_QSTR(MP_QSTR_AF6_I2C3),        MP_ROM_INT(GPIO_AF6_I2C3) },
#endif
#if defined(MICROPY_HW_SPI3_SCK)
