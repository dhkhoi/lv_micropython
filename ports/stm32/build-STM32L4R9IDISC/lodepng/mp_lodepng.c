 ...
 *
 * Command line:
 * ../../lib/lv_bindings/gen/gen_mpy.py -M lodepng -E build-STM32L4R9IDISC/lodepng/lodepng.pp.c ../../lib/lv_bindings/driver/png/lodepng/lodepng.h
 *
...
STATIC mp_obj_t mp_lodepng_decode_memory(size_t mp_n_args, const mp_obj_t *mp_args)
{
    ...
    unsigned res = lodepng_decode_memory(out, w, h, in, insize, colortype, bitdepth);
    return mp_obj_new_int_from_uint(res);
}

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_VAR(mp_lodepng_decode_memory_obj, 7, mp_lodepng_decode_memory, lodepng_decode_memory);
...
STATIC mp_obj_t mp_lodepng_decode32(size_t mp_n_args, const mp_obj_t *mp_args)
{
    ...
    const unsigned char *in = mp_to_ptr(mp_args[3]);
    size_t insize = (size_t)mp_obj_get_int(mp_args[4]);
    unsigned res = lodepng_decode32(out, w, h, in, insize);
    return mp_obj_new_int_from_uint(res);
}

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_VAR(mp_lodepng_decode32_obj, 5, mp_lodepng_decode32, lodepng_decode32);
...
STATIC mp_obj_t mp_lodepng_decode24(size_t mp_n_args, const mp_obj_t *mp_args)
{
    ...
    const unsigned char *in = mp_to_ptr(mp_args[3]);
    size_t insize = (size_t)mp_obj_get_int(mp_args[4]);
    unsigned res = lodepng_decode24(out, w, h, in, insize);
    return mp_obj_new_int_from_uint(res);
}

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_VAR(mp_lodepng_decode24_obj, 5, mp_lodepng_decode24, lodepng_decode24);
...
STATIC mp_obj_t mp_lodepng_error_text(size_t mp_n_args, const mp_obj_t *mp_args)
{
    ...
    const char * res = lodepng_error_text(code);
    return convert_to_str((void*)res);
}

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_VAR(mp_lodepng_error_text_obj, 1, mp_lodepng_error_text, lodepng_error_text);
...
STATIC MP_DEFINE_CONST_LV_FUN_OBJ_VAR(mp_lodepng_decompress_settings_init_obj, 1, mp_lodepng_decompress_settings_init, lodepng_decompress_settings_init);
...
STATIC MP_DEFINE_CONST_LV_FUN_OBJ_VAR(mp_lodepng_color_mode_init_obj, 1, mp_lodepng_color_mode_init, lodepng_color_mode_init);
...
STATIC MP_DEFINE_CONST_LV_FUN_OBJ_VAR(mp_lodepng_color_mode_cleanup_obj, 1, mp_lodepng_color_mode_cleanup, lodepng_color_mode_cleanup);
...
STATIC mp_obj_t mp_lodepng_color_mode_copy(size_t mp_n_args, const mp_obj_t *mp_args)
{
    ...
    unsigned res = lodepng_color_mode_copy(dest, source);
    return mp_obj_new_int_from_uint(res);
}

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_VAR(mp_lodepng_color_mode_copy_obj, 2, mp_lodepng_color_mode_copy, lodepng_color_mode_copy);
...
STATIC mp_obj_t mp_lodepng_color_mode_make(size_t mp_n_args, const mp_obj_t *mp_args)
{
    ...
    LodePNGColorMode res = lodepng_color_mode_make(colortype, bitdepth);
    return mp_read_LodePNGColorMode(res);
}

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_VAR(mp_lodepng_color_mode_make_obj, 2, mp_lodepng_color_mode_make, lodepng_color_mode_make);
...
STATIC MP_DEFINE_CONST_LV_FUN_OBJ_VAR(mp_lodepng_palette_clear_obj, 1, mp_lodepng_palette_clear, lodepng_palette_clear);
...
STATIC mp_obj_t mp_lodepng_palette_add(size_t mp_n_args, const mp_obj_t *mp_args)
{
    ...
    unsigned res = lodepng_palette_add(info, r, g, b, a);
    return mp_obj_new_int_from_uint(res);
}

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_VAR(mp_lodepng_palette_add_obj, 5, mp_lodepng_palette_add, lodepng_palette_add);
...
STATIC mp_obj_t mp_lodepng_get_bpp(size_t mp_n_args, const mp_obj_t *mp_args)
{
    ...
    unsigned res = lodepng_get_bpp(info);
    return mp_obj_new_int_from_uint(res);
}

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_VAR(mp_lodepng_get_bpp_obj, 1, mp_lodepng_get_bpp, lodepng_get_bpp);
...
{
    const LodePNGColorMode *info = mp_write_ptr_LodePNGColorMode(mp_args[0]);
    unsigned res = lodepng_get_channels(info);
    return mp_obj_new_int_from_uint(res);
}

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_VAR(mp_lodepng_get_channels_obj, 1, mp_lodepng_get_channels, lodepng_get_channels);
...
{
    const LodePNGColorMode *info = mp_write_ptr_LodePNGColorMode(mp_args[0]);
    unsigned res = lodepng_is_greyscale_type(info);
    return mp_obj_new_int_from_uint(res);
}

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_VAR(mp_lodepng_is_greyscale_type_obj, 1, mp_lodepng_is_greyscale_type, lodepng_is_greyscale_type);
...
{
    const LodePNGColorMode *info = mp_write_ptr_LodePNGColorMode(mp_args[0]);
    unsigned res = lodepng_is_alpha_type(info);
    return mp_obj_new_int_from_uint(res);
}

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_VAR(mp_lodepng_is_alpha_type_obj, 1, mp_lodepng_is_alpha_type, lodepng_is_alpha_type);
...
{
    const LodePNGColorMode *info = mp_write_ptr_LodePNGColorMode(mp_args[0]);
    unsigned res = lodepng_is_palette_type(info);
    return mp_obj_new_int_from_uint(res);
}

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_VAR(mp_lodepng_is_palette_type_obj, 1, mp_lodepng_is_palette_type, lodepng_is_palette_type);
...
{
    const LodePNGColorMode *info = mp_write_ptr_LodePNGColorMode(mp_args[0]);
    unsigned res = lodepng_has_palette_alpha(info);
    return mp_obj_new_int_from_uint(res);
}

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_VAR(mp_lodepng_has_palette_alpha_obj, 1, mp_lodepng_has_palette_alpha, lodepng_has_palette_alpha);
...
{
    const LodePNGColorMode *info = mp_write_ptr_LodePNGColorMode(mp_args[0]);
    unsigned res = lodepng_can_have_alpha(info);
    return mp_obj_new_int_from_uint(res);
}

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_VAR(mp_lodepng_can_have_alpha_obj, 1, mp_lodepng_can_have_alpha, lodepng_can_have_alpha);
...
STATIC mp_obj_t mp_lodepng_get_raw_size(size_t mp_n_args, const mp_obj_t *mp_args)
{
    ...
    size_t res = lodepng_get_raw_size(w, h, color);
    return mp_obj_new_int_from_uint(res);
}

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_VAR(mp_lodepng_get_raw_size_obj, 3, mp_lodepng_get_raw_size, lodepng_get_raw_size);
    ...
    if (dest[0] == MP_OBJ_NULL) {
        ...
        if (dest[1])
        {
            ...
            switch(attr)
            {
                ...
                case MP_QSTR_iccp_name: data->iccp_name = (void*)(char*)mp_obj_str_get_str(dest[1]); break; // converting to char *;
...
STATIC MP_DEFINE_CONST_LV_FUN_OBJ_VAR(mp_lodepng_info_init_obj, 1, mp_lodepng_info_init, lodepng_info_init);
...
STATIC MP_DEFINE_CONST_LV_FUN_OBJ_VAR(mp_lodepng_info_cleanup_obj, 1, mp_lodepng_info_cleanup, lodepng_info_cleanup);
...
STATIC mp_obj_t mp_lodepng_info_copy(size_t mp_n_args, const mp_obj_t *mp_args)
{
    ...
    unsigned res = lodepng_info_copy(dest, source);
    return mp_obj_new_int_from_uint(res);
}

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_VAR(mp_lodepng_info_copy_obj, 2, mp_lodepng_info_copy, lodepng_info_copy);
...
STATIC mp_obj_t mp_lodepng_add_text(size_t mp_n_args, const mp_obj_t *mp_args)
{
    ...
    const char *str = (char*)mp_obj_str_get_str(mp_args[2]);
    unsigned res = lodepng_add_text(info, key, str);
    return mp_obj_new_int_from_uint(res);
}

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_VAR(mp_lodepng_add_text_obj, 3, mp_lodepng_add_text, lodepng_add_text);
...
STATIC MP_DEFINE_CONST_LV_FUN_OBJ_VAR(mp_lodepng_clear_text_obj, 1, mp_lodepng_clear_text, lodepng_clear_text);
...
STATIC mp_obj_t mp_lodepng_add_itext(size_t mp_n_args, const mp_obj_t *mp_args)
{
    LodePNGInfo *info = mp_write_ptr_LodePNGInfo(mp_args[0]);
    const char *key = (char*)mp_obj_str_get_str(mp_args[1]);
    const char *langtag = (char*)mp_obj_str_get_str(mp_args[2]);
    const char *transkey = (char*)mp_obj_str_get_str(mp_args[3]);
    const char *str = (char*)mp_obj_str_get_str(mp_args[4]);
    unsigned res = lodepng_add_itext(info, key, langtag, transkey, str);
    return mp_obj_new_int_from_uint(res);
}

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_VAR(mp_lodepng_add_itext_obj, 5, mp_lodepng_add_itext, lodepng_add_itext);
...
STATIC MP_DEFINE_CONST_LV_FUN_OBJ_VAR(mp_lodepng_clear_itext_obj, 1, mp_lodepng_clear_itext, lodepng_clear_itext);
...
STATIC mp_obj_t mp_lodepng_set_icc(size_t mp_n_args, const mp_obj_t *mp_args)
{
    ...
    unsigned res = lodepng_set_icc(info, name, profile, profile_size);
    return mp_obj_new_int_from_uint(res);
}

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_VAR(mp_lodepng_set_icc_obj, 4, mp_lodepng_set_icc, lodepng_set_icc);
...
STATIC MP_DEFINE_CONST_LV_FUN_OBJ_VAR(mp_lodepng_clear_icc_obj, 1, mp_lodepng_clear_icc, lodepng_clear_icc);
...
STATIC mp_obj_t mp_lodepng_convert(size_t mp_n_args, const mp_obj_t *mp_args)
{
    ...
    unsigned res = lodepng_convert(out, in, mode_out, mode_in, w, h);
    return mp_obj_new_int_from_uint(res);
}

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_VAR(mp_lodepng_convert_obj, 6, mp_lodepng_convert, lodepng_convert);
...
STATIC MP_DEFINE_CONST_LV_FUN_OBJ_VAR(mp_lodepng_decoder_settings_init_obj, 1, mp_lodepng_decoder_settings_init, lodepng_decoder_settings_init);
...
STATIC MP_DEFINE_CONST_LV_FUN_OBJ_VAR(mp_lodepng_state_init_obj, 1, mp_lodepng_state_init, lodepng_state_init);
...
STATIC MP_DEFINE_CONST_LV_FUN_OBJ_VAR(mp_lodepng_state_cleanup_obj, 1, mp_lodepng_state_cleanup, lodepng_state_cleanup);
...
STATIC MP_DEFINE_CONST_LV_FUN_OBJ_VAR(mp_lodepng_state_copy_obj, 2, mp_lodepng_state_copy, lodepng_state_copy);
...
STATIC mp_obj_t mp_lodepng_decode(size_t mp_n_args, const mp_obj_t *mp_args)
{
    ...
    unsigned res = lodepng_decode(out, w, h, state, in, insize);
    return mp_obj_new_int_from_uint(res);
}

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_VAR(mp_lodepng_decode_obj, 6, mp_lodepng_decode, lodepng_decode);
...
STATIC mp_obj_t mp_lodepng_inspect(size_t mp_n_args, const mp_obj_t *mp_args)
{
    ...
    const unsigned char *in = mp_to_ptr(mp_args[3]);
    size_t insize = (size_t)mp_obj_get_int(mp_args[4]);
    unsigned res = lodepng_inspect(w, h, state, in, insize);
    return mp_obj_new_int_from_uint(res);
}

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_VAR(mp_lodepng_inspect_obj, 5, mp_lodepng_inspect, lodepng_inspect);
...
STATIC mp_obj_t mp_lodepng_inspect_chunk(size_t mp_n_args, const mp_obj_t *mp_args)
{
    ...
    unsigned res = lodepng_inspect_chunk(state, pos, in, insize);
    return mp_obj_new_int_from_uint(res);
}

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_VAR(mp_lodepng_inspect_chunk_obj, 4, mp_lodepng_inspect_chunk, lodepng_inspect_chunk);
...
STATIC mp_obj_t mp_lodepng_chunk_length(size_t mp_n_args, const mp_obj_t *mp_args)
{
    ...
    unsigned res = lodepng_chunk_length(chunk);
    return mp_obj_new_int_from_uint(res);
}

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_VAR(mp_lodepng_chunk_length_obj, 1, mp_lodepng_chunk_length, lodepng_chunk_length);
...
STATIC MP_DEFINE_CONST_LV_FUN_OBJ_VAR(mp_lodepng_chunk_type_obj, 2, mp_lodepng_chunk_type, lodepng_chunk_type);
...
{
    const unsigned char *chunk = mp_to_ptr(mp_args[0]);
    const char *type = (char*)mp_obj_str_get_str(mp_args[1]);
    unsigned char res = lodepng_chunk_type_equals(chunk, type);
    return mp_obj_new_int_from_uint(res);
}

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_VAR(mp_lodepng_chunk_type_equals_obj, 2, mp_lodepng_chunk_type_equals, lodepng_chunk_type_equals);
...
{
    const unsigned char *chunk = mp_to_ptr(mp_args[0]);
    unsigned char res = lodepng_chunk_ancillary(chunk);
    return mp_obj_new_int_from_uint(res);
}

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_VAR(mp_lodepng_chunk_ancillary_obj, 1, mp_lodepng_chunk_ancillary, lodepng_chunk_ancillary);
...
{
    const unsigned char *chunk = mp_to_ptr(mp_args[0]);
    unsigned char res = lodepng_chunk_private(chunk);
    return mp_obj_new_int_from_uint(res);
}

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_VAR(mp_lodepng_chunk_private_obj, 1, mp_lodepng_chunk_private, lodepng_chunk_private);
...
{
    const unsigned char *chunk = mp_to_ptr(mp_args[0]);
    unsigned char res = lodepng_chunk_safetocopy(chunk);
    return mp_obj_new_int_from_uint(res);
}

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_VAR(mp_lodepng_chunk_safetocopy_obj, 1, mp_lodepng_chunk_safetocopy, lodepng_chunk_safetocopy);
...
STATIC mp_obj_t mp_lodepng_chunk_data(size_t mp_n_args, const mp_obj_t *mp_args)
{
    ...
    unsigned char * res = lodepng_chunk_data(chunk);
    return ptr_to_mp((void*)res);
}

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_VAR(mp_lodepng_chunk_data_obj, 1, mp_lodepng_chunk_data, lodepng_chunk_data);
...
{
    const unsigned char *chunk = mp_to_ptr(mp_args[0]);
    const unsigned char * res = lodepng_chunk_data_const(chunk);
    return convert_to_str((void*)res);
}

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_VAR(mp_lodepng_chunk_data_const_obj, 1, mp_lodepng_chunk_data_const, lodepng_chunk_data_const);
...
{
    const unsigned char *chunk = mp_to_ptr(mp_args[0]);
    unsigned res = lodepng_chunk_check_crc(chunk);
    return mp_obj_new_int_from_uint(res);
}

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_VAR(mp_lodepng_chunk_check_crc_obj, 1, mp_lodepng_chunk_check_crc, lodepng_chunk_check_crc);
...
STATIC MP_DEFINE_CONST_LV_FUN_OBJ_VAR(mp_lodepng_chunk_generate_crc_obj, 1, mp_lodepng_chunk_generate_crc, lodepng_chunk_generate_crc);
...
{
    unsigned char *chunk = mp_to_ptr(mp_args[0]);
    unsigned char * res = lodepng_chunk_next(chunk);
    return ptr_to_mp((void*)res);
}

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_VAR(mp_lodepng_chunk_next_obj, 1, mp_lodepng_chunk_next, lodepng_chunk_next);
...
{
    const unsigned char *chunk = mp_to_ptr(mp_args[0]);
    const unsigned char * res = lodepng_chunk_next_const(chunk);
    return convert_to_str((void*)res);
}

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_VAR(mp_lodepng_chunk_next_const_obj, 1, mp_lodepng_chunk_next_const, lodepng_chunk_next_const);
...
STATIC mp_obj_t mp_lodepng_chunk_find(size_t mp_n_args, const mp_obj_t *mp_args)
{
    ...
    unsigned char * res = lodepng_chunk_find(chunk, end, type);
    return ptr_to_mp((void*)res);
}

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_VAR(mp_lodepng_chunk_find_obj, 3, mp_lodepng_chunk_find, lodepng_chunk_find);
...
STATIC mp_obj_t mp_lodepng_chunk_find_const(size_t mp_n_args, const mp_obj_t *mp_args)
{
    ...
    const unsigned char *end = mp_to_ptr(mp_args[1]);
    const char *type = mp_arr_to_char___5__(mp_args[2]);
    const unsigned char * res = lodepng_chunk_find_const(chunk, end, type);
    return convert_to_str((void*)res);
}

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_VAR(mp_lodepng_chunk_find_const_obj, 3, mp_lodepng_chunk_find_const, lodepng_chunk_find_const);
...
STATIC mp_obj_t mp_lodepng_chunk_append(size_t mp_n_args, const mp_obj_t *mp_args)
{
    ...
    unsigned res = lodepng_chunk_append(out, outlength, chunk);
    return mp_obj_new_int_from_uint(res);
}

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_VAR(mp_lodepng_chunk_append_obj, 3, mp_lodepng_chunk_append, lodepng_chunk_append);
...
STATIC mp_obj_t mp_lodepng_chunk_create(size_t mp_n_args, const mp_obj_t *mp_args)
{
    ...
    const char *type = (char*)mp_obj_str_get_str(mp_args[3]);
    const unsigned char *data = mp_to_ptr(mp_args[4]);
    unsigned res = lodepng_chunk_create(out, outlength, length, type, data);
    return mp_obj_new_int_from_uint(res);
}

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_VAR(mp_lodepng_chunk_create_obj, 5, mp_lodepng_chunk_create, lodepng_chunk_create);
...
STATIC mp_obj_t mp_lodepng_crc32(size_t mp_n_args, const mp_obj_t *mp_args)
{
    ...
    unsigned res = lodepng_crc32(buf, len);
    return mp_obj_new_int_from_uint(res);
}

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_VAR(mp_lodepng_crc32_obj, 2, mp_lodepng_crc32, lodepng_crc32);
...
STATIC mp_obj_t mp_lodepng_inflate(size_t mp_n_args, const mp_obj_t *mp_args)
{
    ...
    unsigned res = lodepng_inflate(out, outsize, in, insize, settings);
    return mp_obj_new_int_from_uint(res);
}

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_VAR(mp_lodepng_inflate_obj, 5, mp_lodepng_inflate, lodepng_inflate);
...
STATIC mp_obj_t mp_lodepng_zlib_decompress(size_t mp_n_args, const mp_obj_t *mp_args)
{
    ...
    size_t insize = (size_t)mp_obj_get_int(mp_args[3]);
    const LodePNGDecompressSettings *settings = mp_write_ptr_LodePNGDecompressSettings(mp_args[4]);
    unsigned res = lodepng_zlib_decompress(out, outsize, in, insize, settings);
    return mp_obj_new_int_from_uint(res);
}

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_VAR(mp_lodepng_zlib_decompress_obj, 5, mp_lodepng_zlib_decompress, lodepng_zlib_decompress);
