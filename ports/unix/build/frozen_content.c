...
STATIC byte fun_data_upip__lt_module_gt__op_split[83] = {
    ...
    MP_QSTR_upip_dot_py & 0xff, MP_QSTR_upip_dot_py >> 8,
    0x80, 0x1d, 0x28, 0x29, 0x2b, 0x2c, 0x27, 0x24, 0x24, 0x24, 0x00,
    0xb0, 
...
STATIC byte fun_data_upip__lt_module_gt___makedirs[188] = {
    ...
    MP_QSTR_upip_dot_py & 0xff, MP_QSTR_upip_dot_py >> 8,
    0x80, 0x2c, 0x22, 0x24, 0x37, 0x2a, 0x24, 0x26, 0x2e, 0x26, 0x24, 0x23, 0x2b, 0x52, 0x1f, 0x27, 0x22, 0x2f, 0x00,
    0x50, 
    0xc2, 
    0x10, MP_QSTR_ & 0xff, MP_QSTR_ >> 8, 
    0xc3, 
...
STATIC byte fun_data_upip__lt_module_gt__save_file[67] = {
    ...
    MP_QSTR_upip_dot_py & 0xff, MP_QSTR_upip_dot_py >> 8,
    0x80, 0x40, 0x20, 0x2e, 0x20, 0x2b, 0x24, 0x23, 0x00,
...
STATIC byte fun_data_upip__lt_module_gt__install_tar[256] = {
    ...
    MP_QSTR_upip_dot_py & 0xff, MP_QSTR_upip_dot_py >> 8,
    0x80, 0x49, 0x23, 0x46, 0x26, 0x23, 0x5e, 0x48, 0x22, 0x50, 0x32, 0x2b, 0x31, 0x22, 0x27, 0x2b, 0x4a, 0x24, 0x24, 0x31, 0x27, 0x2b, 0x28, 0x28, 0x2c, 0x00,
    0x2c, 0x00, 
    0xc2, 
    0xb0, 
    0x5f, 
...
STATIC byte fun_data_upip__lt_module_gt__url_open[361] = {
    0x89, 0x12, 0x4e,
    MP_QSTR_url_open & 0xff, MP_QSTR_url_open >> 8,
    MP_QSTR_upip_dot_py & 0xff, MP_QSTR_upip_dot_py >> 8,
    0x80, 0x71, 0x40, 0x27, 0x48, 0x30, 0x23, 0x1f, 0x48, 0x56, 0x44, 0x33, 0x43, 0x4a, 0x28, 0x30, 0x27, 0x2b, 0x64, 0x2e, 0x27, 0x2d, 0x27, 0x2e, 0x29, 0x28, 0x20, 0x27, 0x24, 0x29, 0x27, 0x56, 0x27, 0x4c, 0x00,
    0x12, MP_QSTR_debug & 0xff, MP_QSTR_debug >> 8,  0x00,
    0x44, 0x08, 0x80, 
    0x12, MP_QSTR_print & 0xff, MP_QSTR_print >> 8,  0x00,
    0xb0, 
...
STATIC byte fun_data_upip__lt_module_gt__get_pkg_metadata[101] = {
    ...
    MP_QSTR_upip_dot_py & 0xff, MP_QSTR_upip_dot_py >> 8,
    0x80, 0x9f, 0x29, 0x23, 0x5c, 0x28, 0x23, 0x4c, 0x2b, 0x00,
...
STATIC byte fun_data_upip__lt_module_gt__install_pkg[189] = {
    ...
    MP_QSTR_upip_dot_py & 0xff, MP_QSTR_upip_dot_py >> 8,
    0x80, 0xb2, 0x48, 0x2a, 0x28, 0x22, 0x2a, 0x31, 0x28, 0x2f, 0x28, 0x28, 0x23, 0x2f, 0x2f, 0x4a, 0x28, 0x22, 0x22, 0x2a, 0x00,
...
STATIC byte fun_data_upip__lt_module_gt__install[313] = {
    0xfa, 0x03, 0x46,
    MP_QSTR_install & 0xff, MP_QSTR_install >> 8,
    MP_QSTR_upip_dot_py & 0xff, MP_QSTR_upip_dot_py >> 8,
    0x80, 0xca, 0x20, 0x34, 0x29, 0x44, 0x26, 0x27, 0x2a, 0x26, 0x2e, 0x24, 0x4b, 0x23, 0x23, 0x23, 0x27, 0x2b, 0x28, 0x26, 0x23, 0x29, 0x28, 0x27, 0x28, 0x32, 0x24, 0x32, 0x5c, 0x50, 0x00,
    0x12, MP_QSTR_gc & 0xff, MP_QSTR_gc >> 8,  0x00,
...
STATIC byte fun_data_upip__lt_module_gt__get_install_path[53] = {
    ...
    MP_QSTR_upip_dot_py & 0xff, MP_QSTR_upip_dot_py >> 8,
    0x80, 0xed, 0x20, 0x49, 0x2d, 0x2d, 0x00,
...
STATIC byte fun_data_upip__lt_module_gt__help[51] = {
    0x18, 0x14,
    MP_QSTR_help & 0xff, MP_QSTR_help >> 8,
    MP_QSTR_upip_dot_py & 0xff, MP_QSTR_upip_dot_py >> 8,
    0x80, 0xfc, 0x89, 0x08, 0x33, 0x00,
    0x12, MP_QSTR_print & 0xff, MP_QSTR_print >> 8,  0x00,
    0x23, 0x00, 
    0x34, 0x01, 
    0x59, 
...
STATIC byte fun_data_upip__lt_module_gt__main[456] = {
    ...
    MP_QSTR_upip_dot_py & 0xff, MP_QSTR_upip_dot_py >> 8,
    0x90, 0x0c, 0x20, 0x20, 0x20, 0x44, 0x1f, 0x36, 0x27, 0x42, 0x31, 0x49, 0x43, 0x22, 0x23, 0x2b, 0x24, 0x30, 0x27, 0x22, 0x28, 0x2d, 0x27, 0x28, 0x2b, 0x24, 0x2b, 0x20, 0x27, 0x24, 0x23, 0x2a, 0x23, 0x36, 0x28, 0x2f, 0x27, 0x28, 0x47, 0x1f, 0x52, 0x34, 0x24, 0x27, 0x42, 0x48, 0x27, 0x00,
    0x51, 
    0x17, MP_QSTR_install_path & 0xff, MP_QSTR_install_path >> 8, 
    0x12, MP_QSTR_len & 0xff, MP_QSTR_len >> 8,  0x00,
    0x12, MP_QSTR_sys & 0xff, MP_QSTR_sys >> 8,  0x00,
...
STATIC byte fun_data_upip__lt_module_gt_[306] = {
    0x18, 0x70,
    MP_QSTR__lt_module_gt_ & 0xff, MP_QSTR__lt_module_gt_ >> 8,
    MP_QSTR_upip_dot_py & 0xff, MP_QSTR_upip_dot_py >> 8,
    0x80, 0x07, 0x28, 0x28, 0x28, 0x28, 0x28, 0x28, 0x28, 0x6a, 0x24, 0x29, 0x24, 0x25, 0x44, 0x4c, 0x6f, 0x85, 0x0b, 0x65, 0x20, 0x8b, 0x14, 0x85, 0x09, 0x85, 0x1f, 0x65, 0x60, 0x28, 0x28, 0x24, 0x85, 0x2e, 0x85, 0x0d, 0x69, 0x60, 0x85, 0x17, 0x89, 0x24, 0x85, 0x08, 0x85, 0x07, 0x85, 0x10, 0x85, 0x37, 0x2b, 0x00,
    0x80, 
    0x51, 
